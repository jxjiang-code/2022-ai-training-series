...
parser.add_argument('--checkpoint_dir', default='./checkpoints/tf2_mnist',
                    help='What is the save checkpoint_dir')
...
for ep in range(args.epochs):
    ...
    # HVD - 7 Save the network after epoch
    if (hvd.rank() == 0):
